...
public class Aula5ExercicioEscola {
    /*
    ...
    public static void main(String[] args) {
        ...
        Aula5EnumExercicioEscola tipo = Aula5EnumExercicioEscola.valueOf(tipoEscola);
//Aqui transformei a String em enum
    ...
    private static boolean verificarAprovacao(Aula5EnumExercicioEscola tipo, int somaNotas) {
